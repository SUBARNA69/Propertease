...
namespace Propertease.Migrations
{
    ...
    [Migration("20250329083212_chatupdated")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Propertease.Models.ChatMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Propertease.Models.ChatMessage", b =>
                {
                    b.HasOne("Propertease.Models.User", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Propertease.Models.User", "Sender")
                        .WithMany()
